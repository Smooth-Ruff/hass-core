...
async def main():
    ...
    try:
        flight_info = await fetch_flight_info(
            airport, scheduled, flight_type, flight_id
        )
        ...
        for flight in flight_info.flights:
            if flight_type == "D":
                ...
                print(
                    f"Departure Airport (Swedish): {departure.arrival_airport_swedish}"
                )
                print(
                    f"Departure Airport (English): {departure.arrival_airport_english}"
                )
                ...
                print(
                    f"Flight Leg Status: {departure.location_and_status.flight_leg_status}"
                )
            else:
                ...
                print(
                    f"Flight Leg Status: {arrival.location_and_status.flight_leg_status}"
                )
